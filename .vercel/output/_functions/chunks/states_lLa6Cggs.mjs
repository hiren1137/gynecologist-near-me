const indianStates = [
  ...
  },
  {
    name: "Manipur",
    slug: "manipur",
    cities: ["Imphal", "Thoubal", "Bishnupur", "Churachandpur", "Kakching", "Ukhrul", "Senapati", "Tamenglong", "Jiribam", "Kangpokpi"]
  },
  {
    name: "Meghalaya",
    slug: "meghalaya",
  ...
  },
  {
    name: "Tripura",
    slug: "tripura",
    cities: ["Agartala", "Dharmanagar", "Udaipur", "Kailasahar", "Belonia", "Khowai", "Ambassa", "Ranir Bazar", "Sonamura", "Kumarghat"]
  },
  {
    name: "Uttar Pradesh",
    slug: "uttar-pradesh",
  ...
  },
  {
    name: "Delhi",
    slug: "delhi",
    cities: ["New Delhi", "Central Delhi", "North Delhi", "South Delhi", "East Delhi", "West Delhi", "North East Delhi", "North West Delhi", "South East Delhi", "South West Delhi"]
  },
  {
    name: "Jammu and Kashmir",
    slug: "jammu-and-kashmir",
    cities: ["Srinagar", "Jammu", "Baramulla", "Anantnag", "Sopore", "KathuaUdhampur", "Punch", "Rajouri", "Kupwara"]
  },
  {
    name: "Ladakh",
    slug: "ladakh",
    cities: ["Leh", "Kargil", "Nubra", "Zanskar", "Changthang", "Sham", "Rupshu", "Dras", "Sankoo", "Turtuk"]
  }
];
...
export { indianStates as i, topCities as t };
